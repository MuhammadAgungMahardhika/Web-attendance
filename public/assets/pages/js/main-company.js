...
function addModal() {
    const modalHeader = "Add Main Company";
    const modalBody = `
...
function deleteModal(id) {
    const modalHeader = "Delete Main Company";
    const modalBody = `Are you sure to delete this Main Company`;
...
function save() {
    ...
    $.ajax({
        ...
        success: function (response) {
            showSuccessAlert("New main-company Added!");
            closeModal();
            return showTable();
        },
        error: function (err) {
